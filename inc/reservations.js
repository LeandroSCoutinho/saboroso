...
module.exports = {
     ...
     getReservations(req){
      ...
      return new Promise((resolve, reject) =>{
        ...
        let pag = new Pagination(`SELECT * FROM tb_reservations ${(dtstart && dtend) ? 'WHERE date BETWEEN ? AND ?' : ''} ORDER BY name LIMIT ?,?`,
                  params
            );
          ...
          `, [
            ...
            if (err) {
              ...
              results.forEach(row => {
                ...
                values.push(row.avg_people); // Altere para pegar 'avg_people' ou o que você deseja
              });
